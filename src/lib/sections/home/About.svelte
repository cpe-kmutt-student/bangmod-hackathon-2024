...
<div
	{...$$restProps}
	class={twMerge(
		'mt-[100vh] flex min-h-screen flex-col justify-center gap-x-20 gap-y-8 bg-aubergine px-6 py-12 lg:px-16 lg:py-20',
		$$props.class
	)}
>
	<h1 class="font-mali flex flex-col gap-4 text-center text-xl font-semibold text-white md:text-left md:text-5xl">
		<span>
	...
	<div class="flex w-full max-w-3xl justify-center md:justify-end">
		<p class="text-md max-w-3xl text-center md:text-end font-light text-white md:text-2xl">
